        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <aside class="md:col-span-1 bg-gray-200 p-4">
                <ul class="space-y-2">
                    ...
                    <li><a href="#view-messages" class="block px-2 py-1 rounded-md hover:bg-gray-300">View Messages</a></li>
                </ul>
            </aside>
            ...
            <div class="md:col-span-3 bg-white p-4">
                ...
                <section id="add-skill" class="mb-8">
                    ...
                    <form action="" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" class="w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2">
                        </div>
                        <div>
                            <label for="url" class="block font-semibold">Skill Image URL</label>
                            <input type="text" id="url" name="url" class="w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2">
                        </div>
                        <div>
                            <label for="category" class="block font-semibold">Category</label>
                            <select id="category" name="category" class="w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2">
                                <option value="Backend">Backend</option>
                                <option value="Frontend">Frontend</option>
                                <option value="Desktop">Desktop</option>
                            </select>
                        </div>
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Add Skill</button>
                    </form>
                ...
                <section id="add-project" class="mb-8">
                    ...
                    <form action="{{route('add-project')}}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2"></textarea>
                        </div>
                        <div>
                            <label for="image" class="block font-semibold">Project Image URL</label>
                            <input type="text" id="image" name="image" class="w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2">
                        </div>
                        <div>
                            <label for="githubLink" class="block font-semibold">GitHub Link</label>
                            <input type="text" id="githubLink" name="githubLink" class="w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2">
                        </div>
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Add Project</button>
                    </form>
                </section>
                ...
                <section id="add-client" class="mb-8">
                    ...
                    <form action="" method="POST" class="space-y-4">
                        ...
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Add Client</button>
                    </form>
                        ...
                        <div class="container mx-auto">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div class="bg-white shadow-md rounded-md p-4">
                                    ...
                                    <p class="text-gray-500"><strong>Received At:</strong> {{ $message->created_at->format('Y-m-d H:i:s') }}</p>
                                </div>
                                @endforeach
                            </div>
                        </div>
