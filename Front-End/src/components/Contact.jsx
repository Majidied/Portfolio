  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className={`${styles.sectionHeadText} text-black`}>Contact.</h3>
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-tertiary py-4 px-6 placeholder:text-white text-black rounded-lg outline-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
